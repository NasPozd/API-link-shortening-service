...
## Результаты тестов
Все 19 тестов прошли успешно. С логами запуска контейнеров и результатами тестов можно ознакомиться в файле [здесь](https://<ваш-username>.github.io/<имя-репозитория>/docs/your-file.html).
